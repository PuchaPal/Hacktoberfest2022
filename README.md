...
# Submit your PR on this new repo [Hacktoberfest](https://github.com/PuchaPal/Hacktoberfest2022) , There we are merging all PR. 

In this current repo, there are alot of conflicts, we are not merging until all conflicts get resolved.
Hacktoberfest { [Live Website](https://PuchaPal.github.io/Hacktoberfest2022/)}
...
```terminal
git clone https://github.com/PuchaPal/Hacktoberfest2022.git
```
...
```terminal
git remote add upstream https://github.com/PuchaPal/Hacktoberfest2022
```
